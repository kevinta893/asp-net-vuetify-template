...
const webpathConfig = {
    ...
    module: {
        rules: [
            ...
            { test: /\.svg$/, use: { loader: 'svg-url-loader', options: { encoding: 'base64' } } },
            { test: /\.(gif|png|jpg)$/, use: { loader: 'file-loader' } },
            { test: /\.(woff|woff2|eot|ttf)$/, use: 'url-loader?limit=25000' },
            // ESLint rules
            {
                test: /\.(js|vue)$/,
